...
<fmt:formatDate value="${meet.meetDate}" pattern="yyyy-MM-dd'T'HH:mm" var="fmtDate"/>
...
<style>
    /* 추가적인 커스텀 스타일 */
    .form-title { margin-bottom: 20px; border-bottom: 1px solid #eee; padding-bottom: 10px; }
    .btn-group-custom { margin-top: 20px; text-align: center; }
</style>
    ...
    <div class="panel panel-default"> <div class="panel-body">
            <form method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly value="${meet.dateNo}" class="form-control" id="dateNo" name="dateNo">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="meetDate">만남일</label>
                            <input type="datetime-local" value="${fmtDate}" class="form-control" id="meetDate" name="meetDate" required>
                        </div>
                    </div>
                </div>
                ...
                <hr> <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="score">평점 (1~10)</label>
                            <input type="number" value="${meet.score}" class="form-control" id="score" name="score" min="0" max="10" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="review" class="form-control" name="review" rows="4">${meet.review}</textarea>
                        </div>
                    </div>
                </div>
