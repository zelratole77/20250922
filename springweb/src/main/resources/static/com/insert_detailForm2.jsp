        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="" class="form-control" id="dateNo" name="dateNo">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="meetDate">만남일</label>
                    <input type="datetime-local" value="" class="form-control" id="meetDate" name="meetDate" required>
                </div>
            </div>
        </div> 
